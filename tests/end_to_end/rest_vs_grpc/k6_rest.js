...
/*
  rest 단일 테스트용 스크립트 파일입니다.

  실행 예시:
    테스트 + 데이터 저장: k6 run --out influxdb=http://localhost:8086/k6 tests/end_to_end/rest_vs_grpc/k6_rest.js
    테스트만: k6 run tests/end_to_end/rest_vs_grpc/k6_rest.js
*/
...
export default function () {
    const url = 'http://localhost:5001/rest/ping';
    ...
    const params = {
        tags: { payload_size: `${PAYLOAD_SIZE}`, protocol: 'rest'},
        headers: {
            'Content-Type': 'application/json',
            'Accpet': 'application/json',
            'User-Agent': 'k6-rest-test'
        }
    };
